...
const transporter = nodemailer.createTransport({
  ...
  secure: false,             // false for STARTTLS (true only for port 465)
  auth: {
    user: env.SMTP_USER,
    pass: env.SMTP_PASS,     // the 16-character app password, no spaces
  },
  tls: {
    rejectUnauthorized: false // TEMPORARY: bypass local SSL inspection
  }
});
